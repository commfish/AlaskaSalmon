...
Chilkoot <- read_csv('../data/Chilkoot_Sock.csv') #Use:   '../data/ '  to grab data with knittr, OR just data/ to run from R
glimpse(Chilkoot)
...
From this you can see small differences in Ssmy calculated using Lambert's W (Smsy) vs. Hilborn's approximation (Hilmsy).
...
msy.rHil <- alpha*Hilmsy*exp(-b*Hilmsy) #predict recruits at MSY using Hilborn approximation

Chilkoot$msy.s <- Smsy ###adds Smsy to the dataframe
Chilkoot$msy.r <- msy.r  ###adds msy.r to the data frame
Chilkoot$msy.rHil <- msy.rHil ## adds msy.rHil to the data frame
