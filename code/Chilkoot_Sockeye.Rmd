...
```{r}
a <- coef(rick)[1]  ## 'a' is for calculating S msy, it is in the log space
a
alpha <- exp(coef(rick)[1]) ##'alpha' is for prediction of recruits, this takes it from a log space to numbers of fish.
alpha
b <- -coef(rick)[2]  #Note that it is asking for the negative coeficient of the ricker function.
b
...
>>>>>>> c5d16004ba478b1eb598fde7316ff87c5fe823dd
```{r Autocorrelation}
